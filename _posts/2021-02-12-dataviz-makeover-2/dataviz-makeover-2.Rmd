...
description: 
  Statistics on public willingness to receive the Covid-19 vaccination across different countries
author:
  - name: Andre Lee
    url: 
date: 02-12-2021
...
![Fig 25: Create calculated field 'Strongly Agree Count'](images/stronglyagreecount.PNG)
...
![Fig 26: Create calculated field 'Proportion of respondents _Strongly Agree'](images/proportionsofrespondents.PNG)
...
![Fig 27: Create calculated field 'Proportion Standard Error_Strongly Agree'](images/proportionstandarderror.PNG)
...
![Fig 28: Create calculated field Z_95%](images/Z95.PNG)
...
![Fig 29: create calculated field 'Upper 95%_Strongly Agree'](images/upper95_stronglyagree.PNG)
...
![Fig 30: Create calculated field 'Lower 95%_Strongly Agree'](images/lower95_stronglyagree.PNG)
...
![](images/selecttypeofresponse.PNG)
...
![](images/femaleworry.PNG)

![](images/maleworry.PNG)
...
![](images/elderworry.PNG)
![](images/youthworry.PNG)